...
// вызвать метод с некорректными аргументами и т.д. Обработайте исключения для каждой операции
// и выведите информацию об ошибках.
public class Task02 {
